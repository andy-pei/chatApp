...
@section('content')
    ...
    <h2 class="form-signin-heading text-center header-image">Edit Post</h2>
    ...
    <div>
        ...
        <div class="form-group">
            ...
            {!! Form::input('text', 'title', $post->title, array('class' => 'form-control')) !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::select('type_id', $post_types, $post->type_id, array('class' => 'form-control')) !!}
        </div>
